    ...
    <div class="row">
      <div class="col-md-12">
        <fieldset>
          ...
          <div class="form-group">
            <label>Fecha</label>
            <input value="<?php print $info_pedido['fecha_pedido'] ?>" type="text" class="form-control" readonly>
          </div>
              ...
              if ($cantidad > 0) {
                ...
                for ($x = 0; $x < $cantidad; $x++) {
                  ...
                  <tr>
                    ...
                    <td><?php print $item['precio'] ?> EUR</td>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input value="<?php print $precioTotal ?>" type="text" class="form-control" readonly>
